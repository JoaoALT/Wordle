import { Text, StyleSheet, SafeAreaView, TouchableOpacity,View, Button } from 'react-native'
...
export default function WordleView({navigation, route}: any) {

  const [activeWord, setActiveWord] = React.useState(words[0])
  const [guessIndex, setGuessIndex] = React.useState(0)
  const [guesses, setGuesses] = React.useState([] as IGuess)
...
function useContext(GameContext: any): { wordSelected: any; saveGame: any } {
